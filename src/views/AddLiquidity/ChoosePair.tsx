  ...
  return (
    <>
      <AppHeader
        ...
        subtitle={t('Receive LP tokens and earn 0.015% trading fees')}
        helper={t(
          'Liquidity providers earn a 0.015% trading fee on all trades made for that token pair, proportional to their share of the liquidity pool.',
        )}
        backTo="/liquidity"
      />
      <CardBody>
