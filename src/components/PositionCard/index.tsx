      ...
      {userPoolBalance && JSBI.greaterThan(userPoolBalance.quotient, BIG_INT_ZERO) ? (
        ...
        <LightCard>
          <Text fontSize="14px" style={{ textAlign: 'center' }}>
            ...
            {t(
              "By adding liquidity you'll earn 0.015% of all trades on this pair proportional to your share of the pool. Fees are added to the pool, accrue in real time and can be claimed by withdrawing your liquidity.",
            )}
          </Text>
        </LightCard>
      )}
